...
// Najprawdopodobniej do wyjebania, ale bez tego nie odpali się beval
// bez którego nie chce się kompilować, bo jest dodany jako następstwo
// do motifa, nie wiem, czy da się to w ogóle zrobić, ale trzeba spróbować
# define FEAT_TOOLBAR
