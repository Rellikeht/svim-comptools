...
#define FEAT_CON_DIALOG
    ...
    (defined(FEAT_GUI_MOTIF) || defined(FEAT_GUI_GTK) ||                       \
...
#if defined(FEAT_GUI) || defined(MCH_CURSOR_SHAPE) ||                          \
    defined(FEAT_MOUSESHAPE) || defined(FEAT_CONCEAL) ||                       \
 ...
 */
#if defined(FEAT_NORMAL) || defined(FEAT_NETBEANS_INTG) ||                     \
    defined(FEAT_PROP_POPUP)
#define FEAT_SIGNS
#if (defined(FEAT_GUI_MOTIF) && defined(HAVE_X11_XPM_H)) ||                    \
    defined(FEAT_GUI_GTK) || (defined(MSWIN) && defined(FEAT_GUI))
